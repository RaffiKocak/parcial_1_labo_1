...
/// El dato ingresado será cada palabra que contenga su primer letra mayúscula, y el resto de las letras en minúscula.
/// @param mensaje
/// @param cadena
/// @param tam
/// @param intentos
...
/// @brief Función auxiliar. Convierte la primer letra de cada palabra en mayúscula, y el resto de las letras en minúscula.
///
/// @param cadena
